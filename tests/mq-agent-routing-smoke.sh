...
grep -q "run_agent_command perception" "$COMMAND_MODE"
grep -q "run_agent_command stack-health" "$COMMAND_MODE"
...
grep -q "mqlaunch perception" "$DOC"
grep -q "mqlaunch stack-health" "$DOC"
