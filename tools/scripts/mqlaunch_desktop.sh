...
# Desktop mode: fullscreen Terminal, stays in foreground
...
# ============================================================
# DESKTOP MODE — Fullscreen + refocus helpers
# ============================================================

# Sätter Terminal till helskärm vid start
enter_fullscreen() {
...
-- Skicka Cmd+Ctrl+F för att gå in i fullscreen
...
# Återfokuserar Terminal och tar det till förgrunden
refocus_terminal() {
  sleep 0.4
...
Usage:
  mqlaunch_desktop                Open main menu (fullscreen)
  mqlaunch_desktop ai             Open AI submenu
  mqlaunch_desktop dev            Open Dev / Prompts submenu
  mqlaunch_desktop tweaks         Open Tweaks menu
  mqlaunch_desktop dashboard      Open Dashboard
  mqlaunch_desktop theme          Open Themes menu
  mqlaunch_desktop tools-menu     Open Tools Menu
...
# ============================================================
# Entry — Desktop mode: enter fullscreen, then start menu
# ============================================================
if [[ $# -gt 0 ]]; then
  run_arg_command "$1"
else
