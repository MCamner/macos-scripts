...
"$PROJECT_ROOT/tests/vector-store-identity-smoke.sh"
...
"$PROJECT_ROOT/tests/ui-zsh-surface-smoke.sh"
...
"$PROJECT_ROOT/tests/pulse-freshness-smoke.sh"
"$PROJECT_ROOT/tests/next-reuse-smoke.sh"
"$PROJECT_ROOT/tests/pulse-concurrency-smoke.sh"
...
"$PROJECT_ROOT/tests/gate-evidence-smoke.sh"
"$PROJECT_ROOT/tests/zsh-status-assignment-smoke.sh"
...
"$PROJECT_ROOT/tests/install-godmode-smoke.sh"
...
"$PROJECT_ROOT/tests/openai-key-rotation-smoke.sh"
