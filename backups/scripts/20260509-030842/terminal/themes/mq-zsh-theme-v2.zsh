...
# Retro amber + clean status + git + duration

[[ -n "${MQ_ZSH_THEME_V2_LOADED:-}" ]] && return 0
export MQ_ZSH_THEME_V2_LOADED=1
...
typeset -g MQC_USER="%F{220}"     # amber
typeset -g MQC_HOST="%F{179}"     # soft amber
typeset -g MQC_PATH="%F{117}"     # cool cyan
typeset -g MQC_GIT="%F{141}"      # purple
typeset -g MQC_OK="%F{46}"        # green
typeset -g MQC_ERR="%F{196}"      # red
typeset -g MQC_WARN="%F{214}"     # orange
typeset -g MQC_TIME="%F{244}"     # gray
typeset -g MQC_DIM="%F{242}"      # dim gray
typeset -g MQC_ACCENT="%F{220}"   # amber accent
